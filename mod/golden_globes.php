...
if (empty($whereParts)) {
    ...
    $winnerCountSql = 'SELECT SUM(winner) FROM golden_globe_nominations gg ' . $whereClause;
    if (!empty($params)) {
    ...
    $yearsCountSql = 'SELECT COUNT(DISTINCT year_award) FROM golden_globe_nominations gg ' . $whereClause;
    if (!empty($params)) {
    ...
    $categoriesCountSql = 'SELECT COUNT(DISTINCT category_id) FROM golden_globe_nominations gg ' . $whereClause;
    if (!empty($params)) {
